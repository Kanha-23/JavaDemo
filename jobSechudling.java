...
public class jobSechudling {
    ...
    public jobSechudling(){}//empty constaructor for creating object

    public jobSechudling(char id, int deadline, int profit){//2nd constructor for inputing value (parametrized)
        this.id = id;
